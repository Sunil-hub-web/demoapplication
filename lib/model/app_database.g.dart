    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Todo` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `mobileno` TEXT NOT NULL, `choose1` TEXT NOT NULL, `choose2` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$TodoDao extends TodoDao {
  ...
  @override
  Future<Todo?> findUserById(int mobileno) async {
    return _queryAdapter.query('SELECT * FROM Todo WHERE mobileno = ?1',
        mapper: (Map<String, Object?> row) => Todo(
            row['id'] as int,
            row['name'] as String,
            row['mobileno'] as String,
