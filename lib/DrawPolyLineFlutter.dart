...
class DrawPolyLineFlutter extends StatefulWidget {
  const DrawPolyLineFlutter({super.key});

  @override
  State<DrawPolyLineFlutter> createState() => _DrawPolyLineFlutterState();
}

class _DrawPolyLineFlutterState extends State<DrawPolyLineFlutter> {
  ...
  double distance1(double lat1, double lon1, double lat2, double lon2) {
    ...
    final dLat = _toRadians(27.6875436 - 27.6683619);
    final dLon = _toRadians(85.2751138 - 85.3101895);
    final lat1Radians = _toRadians(27.6875436);
    final lat2Radians = _toRadians(27.6683619);
